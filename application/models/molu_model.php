...
*
*/
class Molu_model extends CI_Model
{
	...
	function check_user()
	{
		$query = $this->db->get_where('user',array('name' => $this->name,'password' => md5($this->password)));
		if ($row = $query->row_array()){
			return $row;
		}
		return array();
